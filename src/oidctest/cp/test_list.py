    ...
    <div class="container" role="main">
        ...
        <div class="page-header">
            <div class="text-center text-uppercase text-warning border border-danger">
                <p>The certification test suite is migrating to a new service <a href="https://www.certification.openid.net/">here</a> and the OpenID Foundation plans to decommission the existing service at the end of August 2020.</p>
                <p>Please wrap up your testing activities on the existing test suite by then and move them to the new one.</p>
            </div>
            <div class="clearfix"></div>
        </div>
"""
